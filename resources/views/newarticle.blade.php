...
<form action="{{route('a.store')}}" method="post">
    ...
    <div class="px-5 mt-5" style="width: 100%;">
        <input type="text" name="title" class="form-control" style="width:100%; height: 45px;" placeholder="タイトル"  value="{{ old('title') }}" required maxlength="50">
    </div>
    @if ($errors->has('title'))
    ...
    <div class="d-md-flex mx-md-5 my-3">
        ...
        <div class="overflow-auto original" style="height: 600px;">
            <textarea name="body" class="form-control" style="width: 100%; height: 600px;" required maxlength="10000" id="original">{{ old('body') }}</textarea>
        </div>
    ...
    <div class="m-5 text-right">
        <button class="btn btn-primary btn-lg" data-ope="post" id="ope">投稿する</button>
    </div>
</form>
